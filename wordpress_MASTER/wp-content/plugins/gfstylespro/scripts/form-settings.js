...
jQuery('#gform-settings').submit(function() {
    ...
    jQuery('#gform-settings').find( 'input, select').each( function() {
        if (jQuery(this).val() == '') {
